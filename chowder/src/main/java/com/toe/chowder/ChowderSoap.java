...
public class ChowderSoap {
    ...
    public ChowderSoap(Activity activity, String merchantId, String passkey, PaymentListener paymentCompleteListener) {
    ...
    public ChowderSoap(Activity activity, String merchantId, String passkey, String callBackUrl, PaymentListener paymentCompleteListener) {
        this.paymentCompleteListener = paymentCompleteListener;
        this.activity = activity;
        this.merchantId = merchantId;
        this.passkey = passkey;
